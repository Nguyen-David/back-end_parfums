                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="wrapper-count">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-5 col-4 d-flex justify-content-center wrapper-btn-basket">
                                                    <button type="submit" class="btn btn-dark btn-basket">В КОРЗИНУ</button>
                                                </div>
                                        ...
                                        <div class="wrapper-comparison">
                                            <button class=" align-items-center btn-add-comparison display-flex" id="btn-add">
                                                <span class="rating"><i class="fa fa-bar-chart" aria-hidden="true"></i></span>
                                                <span>Добавить сравнение</span>
                                            </button>
                                            <button class=" align-items-center btn-delete-comparison display-none" id="btn-delete">
                                                <span class="rating"><i class="fa fa-bar-chart" aria-hidden="true"></i></span>
                                        ...
                                        <div class="social-network-page">
                                            <ul>
                                                <li class="text-center vkontakte-icon"><a href="vk.com"><i class="fa fa-vk" aria-hidden="true"></i></a></li>
                                                <li class="text-center facobook-icon"><a href="facobook.com"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                                <li class="text-center odnoklassniki-icon"><a href="odnoklassniki.com"><i class="fa fa-odnoklassniki" aria-hidden="true"></i></a></li>
                                                <li class="text-center gmail-icon"><a href="gmail.com"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                                                <li class="text-center twitter-icon"><a href="twitter.com"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                                <li class="text-center github-icon"><a href="github.com"><i class="fa fa-github" aria-hidden="true"></i></a></li>
