...
<script type="text/javascript" src="/template/js/things.js"></script>

<script src="/template/ui/jquery-ui.min.js"></script>
<script src="/template/js/jquery.spinner.js"></script>

<script type="text/javascript" src="/template/slick/slick.min.js"></script>
<script type="text/javascript" src="/template/js/ProductSlider.js"></script>

<script type="text/javascript"  src="/template/js/AddToBasket.js"></script>

<script type="text/javascript" src="/template/js/RangePrice.js"></script>


<script type="text/javascript" src="/template/js/CountBuy.js"></script>
