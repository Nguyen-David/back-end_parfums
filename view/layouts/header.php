...
<head>
    ...
    <link rel="stylesheet" href="/template/ui/jquery-ui.min.css">
    <link rel="stylesheet" href="/template/css/style-slider.css">
                ...
                <div class="col-12 navbar-small ">
                    <nav class="navbar navbar-expand-lg navbar-light bg-nav ">
                        ...
                        <div class="row basket d-flex justify-content-end">
                            ...
                            <div class="graphic ">
                                <a class="count1_fonts" href="/comparison/">
                                    <div class="count1" id="comparison-count3"><?php echo Comparison::countItems()?></div>
            ...
            <div class="row logo-header">
                ...
                <div class="basket-wrapper col-md-3 col-sm-12">
                    <div class="row basket d-flex justify-content-center">
                        <div class="graphic ">
                            <a class="count1_fonts" href="/comparison/">
                                <div class="count1" id="comparison-count2"><?php echo Comparison::countItems()?></div>
                                <div href="#" class="fonts"><i class="fa fa-bar-chart" aria-hidden="true"></i></div>
                            </a>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-nav nav-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link header-menu" href="/user/login/"><strong>Личный кабинет</strong></a>
                                </li>
                            </ul>
                            <form class="form-inline my-2 my-lg-0">
                                <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
